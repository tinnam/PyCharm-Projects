...
def add_image():
    ...
    global my_image
    # grab filename
    my_image = filedialog.askopenfilename(initialdir=".", title="Open File", filetypes = [("Image Files","*.png"),("Image Files","*.jpg")])
    imgToInsert = PhotoImage(file=my_image)
    # print(my_image)
